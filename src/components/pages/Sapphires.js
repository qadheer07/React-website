...
import data from './SapphiresData'
import './Rubies.css'
...
function Sapphires() {
  ...
  const Filters = [
    ...
    return (
      ...
      <div className='nav-bar-backdrop-sapphires'>
            {'\u00a0'}
            </div>
        <div className="top-of-wrapper">
          <h2 className='top-of-sapphires'> Sapphires </h2>
        </div>
                ...
                <div className='make-mobile-column'>  
                  <div className='sorting-mobile'>
                    <label for="sorting">Sort By:{'\u00a0'}</label>
                      <select className="sort-options" id="sort-options">
                        ...
                        <option value="WeightL2H">Weight: Low to High</option>
                        <option value="WeightH2L">Weight: High to Low</option>
                  ...
                  { Filters.map( Filter =>
                    <div className='filter-mobile'>
                      <h4 style={{margin: '20px 0px'}}> {Filter.type} </h4>
            ...
            data.products.map(product =>
              <div className="product-card">
                ...
                <div className="product-details-wrapper">
                  <a href={"/product" + product.__id } className='product-name-sapphire'> <h4>{product.name}</h4> </a> 
