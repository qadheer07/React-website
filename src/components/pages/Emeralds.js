    ...
    return (
        <>
          <section className="list-page-wrapper">
            <div className='nav-bar-backdrop-emerald'>
            {'\u00a0'}
            </div>
            <div className="top-of-wrapper">
              <h2 className='top-of-emeralds'> Emeralds </h2>
            </div>
                ...
                data.products.map(product =>
                  <div className="product-card">
                    ...
                    <div className="product-details-wrapper">
                      <a href={"/product" + product.__id } className='product-name-emerald'> <h4>{product.name}</h4> </a> 
